...
public class Branch extends IntermediateCode implements ProbablyConst, ProbablyCombinable, Usage<Branch> {
    ...
    public boolean isCombinable() {
        if (prev instanceof AssignBinaryOperation) {
            final AssignBinaryOperation code = ((AssignBinaryOperation) prev);
            final AssignBinaryOperation.BinaryOperation op = code.operation;
            switch (op) {
                case GT:
                case GE:
                case LT:
        ...
        } else if (prev instanceof AssignUnaryOperation) {
